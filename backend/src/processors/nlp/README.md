...
| `quality.py` | `Quality` | Lexicon-based heuristics: constructiveness, inspirational value, hope, objectivity, societal impact, readability, novelty — feeds `PositiveImpactScorer`'s admission score (`src/services/admission/`) |
